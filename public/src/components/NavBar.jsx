  ...
  return (
    <div>
      <div className="bg-[#956123] h-[5.125rem] rounded-b-[11px] drop-shadow-md flex justify-between items-center">
        ...
        {hamburgerOpen && <div className="p-3 flex flex-col md:hidden gap-4 bg- h-[100vh] w-[50vw] pt-[100px] absolute z-[-10]">
            <Navlinks/>
        </div>}
      </div>
...
function Navlinks(){
  return(
    ...
    <button className="bg-[#D9D9D9] flex items-center justify-center pl-[28px] pr-[28px] pt-[5px] pb-[5px] text-[16px] rounded-[10px] font-PTserif text-[#956123]">LOG IN</button>
            <button className="border-[#D9D9D9] flex items-center justify-center border-[.1rem] pl-[28px] pr-[28px] pt-[10px] pb-[10px] text-[16px] rounded-[10px] font-PTserif text-[#D9D9D9]">SIGN UP</button>
    </>
  )
}
